...
def test_uftb(request):
    # Create DUT
    uFTB = DUTFauFTB(waveform_filename="report/uftb_with_ftq.vcd", coverage_filename="report/uftb_with_ftq_coverage.dat")
...
if __name__ == "__main__":
    uFTB = DUTFauFTB(waveform_filename="report/uftb_with_ftq.vcd", coverage_filename="report/uftb_with_ftq_coverage.dat")
    # uFTB = DUTFauFTB(waveform_filename="report/uftb_with_ftq.vcd")
